    ...
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 p-4 overflow-hidden">
      ...
      <Card className="relative z-10 w-full max-w-md bg-white text-gray-800 shadow-2xl border border-gray-100 animate-scale-in">
        <CardHeader className="flex flex-col items-center text-center space-y-4 pb-8">
          ...
          <div>
            <CardTitle className="text-3xl font-bold bg-gradient-to-r from-[#517842] to-[#3d5a32] bg-clip-text text-transparent mb-2">Reset Password with Code</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="grid gap-5">
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="w-full h-12 bg-[#FFC107] hover:bg-[#FFD54F] text-[#517842] font-semibold text-base rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
            >
