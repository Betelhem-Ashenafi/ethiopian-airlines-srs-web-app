  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-et-green text-white p-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto px-4">
        ...
        >
          {/* Add a query param so the auth provider knows this navigation originated from the launch button
              and should show the login page even if a user session exists. */}
          <Link href="/login?from=launch">Launch Portal</Link>
        </Button>
      </div>
    </div>
  )
