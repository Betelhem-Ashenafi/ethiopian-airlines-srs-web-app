...
export default function SettingsSection() {
  ...
  const [departments, setDepartments] = useState<{ id: string; name: string; description?: string; departmentEmail?: string; contactNumber?: string; isActive?: boolean }[]>([])
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      ...
      const item = {
        ...
        name: obj.departmentName ?? obj.departmentName ?? newDepartmentName,
        ...
        isActive: obj.isActive ?? payload.isActive,
      }
      ...
      setDepartments(prev => [...prev, { id: String(Date.now()), name: newDepartmentName, description: newDepartmentDescription, departmentEmail: newDepartmentEmail, contactNumber: newDepartmentContact, isActive: newDepartmentActive }])
      setNewDepartmentName('')
      setNewDepartmentDescription('')
      setNewDepartmentEmail('')
      setNewDepartmentContact('')
