...
export default function ReportDetailDialog({ report, isOpen, onClose }: ReportDetailDialogProps) {
  ...
  const [editDeptFields, setEditDeptFields] = useState<DeptFields | {}>({})
                  ...
                  <div className="mb-2 p-2 border rounded bg-gray-50">
                    <div className="flex justify-between items-center">
                      ...
                      <Button size="sm" variant="outline" onClick={() => {
                        ...
                        setEditDeptFields({ ...departmentDetail })
                        setDeptError(null)
                      }}>Edit</Button>
                    </div>
                    {!editingDepartment ? (
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        <div>
                          <Label>Name</Label>
                          <input className="w-full border rounded px-2 py-1" value={editDeptFields.name as string} onChange={e => setEditDeptFields((f: any) => ({ ...f, name: e.target.value }))} />
                        </div>
                        <div>
                          <Label>Description</Label>
                          <input className="w-full border rounded px-2 py-1" value={editDeptFields.description as string} onChange={e => setEditDeptFields((f: any) => ({ ...f, description: e.target.value }))} />
                        </div>
                        <div>
                          <Label>Email</Label>
                          <input className="w-full border rounded px-2 py-1" value={editDeptFields.departmentEmail as string} onChange={e => setEditDeptFields((f: any) => ({ ...f, departmentEmail: e.target.value }))} />
                        </div>
                        <div>
                          <Label>Contact</Label>
                          <input className="w-full border rounded px-2 py-1" value={editDeptFields.contactNumber as string} onChange={e => setEditDeptFields((f: any) => ({ ...f, contactNumber: e.target.value }))} />
                        </div>
                        <div className="flex items-center gap-2">
                          <input type="checkbox" checked={!!editDeptFields.isActive} onChange={e => setEditDeptFields((f: any) => ({ ...f, isActive: e.target.checked }))} />
                          <span>Active</span>
                        </div>
