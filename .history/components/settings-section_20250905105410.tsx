                    ...
                    <div className="overflow-x-auto">
                      <div className="flex flex-col gap-2">
                          {departments.map((dept) => (
                            <div key={dept.id} className="bg-white rounded-md p-4 border border-gray-100">
                              <div className="grid gap-2">
                                <div>
                                  <div className="text-xs text-muted-foreground">Name</div>
                                  <Input className="min-w-0 w-full h-8 text-sm px-2" defaultValue={dept.name} onBlur={(e) => handleUpdateDepartment(dept.id, { name: e.target.value })} />
                                </div>
                                <div>
                                  <div className="text-xs text-muted-foreground">Description</div>
                                  <Input className="min-w-0 w-full h-8 text-sm px-2" defaultValue={dept.description} onBlur={(e) => handleUpdateDepartment(dept.id, { description: e.target.value })} />
                                </div>
                                <div>
                                  <div className="text-xs text-muted-foreground">Email</div>
                                  <Input className="min-w-0 w-full h-8 text-sm px-2" defaultValue={dept.departmentEmail} onBlur={(e) => handleUpdateDepartment(dept.id, { departmentEmail: e.target.value })} />
                                </div>
                                <div>
                                  <div className="text-xs text-muted-foreground">Contact</div>
                                  <Input className="min-w-0 w-full h-8 text-sm px-2" defaultValue={dept.contactNumber} onBlur={(e) => handleUpdateDepartment(dept.id, { contactNumber: e.target.value })} />
                                </div>
