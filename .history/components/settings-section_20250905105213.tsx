                  ...
                  <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
                    ...
                    <div className="overflow-x-auto">
                      <div className="flex flex-col gap-2">
                          ...
                          <div key={dept.id} className="flex items-center gap-2 flex-nowrap bg-white rounded-md p-2 border border-gray-100 overflow-x-auto">
                            <Input className="min-w-0 w-44 h-8 text-sm px-2" defaultValue={dept.name} onBlur={(e) => handleUpdateDepartment(dept.id, { name: e.target.value })} />
                            <Input className="min-w-0 flex-1 h-8 text-sm px-2" defaultValue={dept.description} onBlur={(e) => handleUpdateDepartment(dept.id, { description: e.target.value })} />
                            <Input className="min-w-0 w-56 h-8 text-sm px-2" defaultValue={dept.departmentEmail} onBlur={(e) => handleUpdateDepartment(dept.id, { departmentEmail: e.target.value })} />
                            <Input className="min-w-0 w-40 h-8 text-sm px-2" defaultValue={dept.contactNumber} onBlur={(e) => handleUpdateDepartment(dept.id, { contactNumber: e.target.value })} />
