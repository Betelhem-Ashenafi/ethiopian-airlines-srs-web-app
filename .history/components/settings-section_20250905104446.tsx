                      ...
                      <Table className="w-full text-sm table-auto">
                        <TableHeader>
                          <tr className="text-left">
                            <TableHead className="px-1 py-1 text-sm">Name</TableHead>
                            <TableHead className="px-1 py-1 text-sm">Description</TableHead>
                            <TableHead className="px-1 py-1 text-sm">Email</TableHead>
                            <TableHead className="px-1 py-1 text-sm">Contact</TableHead>
                            <TableHead className="px-1 py-1 text-sm">Active</TableHead>
                            <TableHead className="px-1 py-1 text-sm">Actions</TableHead>
                          </tr>
                        </TableHeader>
                        <TableBody>
                          {departments.map((dept) => (
                            <TableRow key={dept.id} className="odd:bg-white even:bg-gray-50">
                              <TableCell className="px-1 py-1 align-top w-40">
                                <Input className="min-w-0 h-8 text-sm px-2" defaultValue={dept.name} onBlur={(e) => handleUpdateDepartment(dept.id, { name: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-1 py-1 align-top">
                                <Input className="min-w-0 h-8 text-sm px-2" defaultValue={dept.description} onBlur={(e) => handleUpdateDepartment(dept.id, { description: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-1 py-1 align-top w-56">
                                <Input className="min-w-0 h-8 text-sm px-2" defaultValue={dept.departmentEmail} onBlur={(e) => handleUpdateDepartment(dept.id, { departmentEmail: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-1 py-1 align-top w-36">
                                <Input className="min-w-0 h-8 text-sm px-2" defaultValue={dept.contactNumber} onBlur={(e) => handleUpdateDepartment(dept.id, { contactNumber: e.target.value })} />
                              </TableCell>
