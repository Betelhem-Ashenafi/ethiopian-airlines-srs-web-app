  ...
  useEffect(() => {
    ...
    if (!isLoading) {
      ...
      if (!user && !isPublic) {
        ...
        // If logged in, normally redirect from auth pages to dashboard.
        // However, if the page is /login and the query param from=launch is present,
        // allow showing the login page (the user intentionally clicked Launch Portal).
        try {
