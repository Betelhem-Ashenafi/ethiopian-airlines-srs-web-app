...
export default function ReportDetailDialog({ report, isOpen, onClose }: ReportDetailDialogProps) {
  // ...existing code...
  const [departmentDetail, setDepartmentDetail] = useState<any | null>(null)
  const [editingDepartment, setEditingDepartment] = useState(false)
  const [editDeptFields, setEditDeptFields] = useState<any>({})
  ...
  useEffect(() => {
    ...
    async function loadDept() {
      if (!isOpen) return
      // Try to get department id from report
      const deptId = report.departmentId ?? report.departmentID ?? report.department_id ?? null
