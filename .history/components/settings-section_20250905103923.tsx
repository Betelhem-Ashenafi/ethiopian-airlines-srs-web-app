                          ...
                          {departments.map((dept) => (
                            <tr key={dept.id} className="odd:bg-white even:bg-gray-50">
                              <td className="px-2 py-2 align-top w-48">
                                <Input defaultValue={dept.name} onBlur={(e) => handleUpdateDepartment(dept.id, { name: e.target.value })} />
                              </td>
                              <td className="px-2 py-2 align-top">
                                <Input defaultValue={dept.description} onBlur={(e) => handleUpdateDepartment(dept.id, { description: e.target.value })} />
                              </td>
                              <td className="px-2 py-2 align-top w-64">
                                <Input defaultValue={dept.departmentEmail} onBlur={(e) => handleUpdateDepartment(dept.id, { departmentEmail: e.target.value })} />
                              </td>
                              <td className="px-2 py-2 align-top w-40">
                                <Input defaultValue={dept.contactNumber} onBlur={(e) => handleUpdateDepartment(dept.id, { contactNumber: e.target.value })} />
                              </td>
