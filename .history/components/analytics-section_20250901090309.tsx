  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Chart rendering for System Admin */}
        {user?.role === "System Admin" && (
          <Card>
            <CardHeader>
            ...
            <CardContent>
              {chartType === "bar" && (
                <div style={{ width: "100%", height: 300 }}>
                  {/* Bar chart for reports by severity */}
              ...
              {chartType === "pie" && (
                <div style={{ width: "100%", height: 300 }}>
                  {/* Pie chart for reports by severity */}
              ...
              {chartType === "line" && (
                <div style={{ width: "100%", height: 300 }}>
                  {/* Line chart for reports by severity */}
        ...
        {/* ...existing cards for other users or additional analytics... */}
      </div>
