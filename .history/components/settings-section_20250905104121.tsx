                      ...
                      <Table className="w-full text-sm table-auto">
                        <TableHeader>
                          <tr className="text-left">
                            ...
                            <TableHead className="px-2 py-2">Active</TableHead>
                        ...
                        <TableBody>
                          {departments.map((dept) => (
                            <TableRow key={dept.id} className="odd:bg-white even:bg-gray-50">
                              <TableCell className="px-2 py-2 align-top w-48">
                                <Input className="min-w-0" defaultValue={dept.name} onBlur={(e) => handleUpdateDepartment(dept.id, { name: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-2 py-2 align-top">
                                <Input className="min-w-0" defaultValue={dept.description} onBlur={(e) => handleUpdateDepartment(dept.id, { description: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-2 py-2 align-top w-64">
                                <Input className="min-w-0" defaultValue={dept.departmentEmail} onBlur={(e) => handleUpdateDepartment(dept.id, { departmentEmail: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-2 py-2 align-top w-40">
                                <Input className="min-w-0" defaultValue={dept.contactNumber} onBlur={(e) => handleUpdateDepartment(dept.id, { contactNumber: e.target.value })} />
                              </TableCell>
                              <TableCell className="px-2 py-2 align-top text-center">
                                <input type="checkbox" defaultChecked={Boolean(dept.isActive)} onChange={(e) => handleUpdateDepartment(dept.id, { isActive: e.target.checked })} />
                              </TableCell>
