...
export function AuthProvider({ children }: {children :ReactNode }) {
    ...
    async function restoreUser() {
      ...
      try {
        ...
        if (profile) {
          ...
          if (profile.role && displayRoleMap[profile.role]) profile.role = displayRoleMap[profile.role] as "System Admin" | "Department Admin" | "Employee"
          setUser(profile)
  ...
  if (userData.role && displayRoleMap[userData.role]) userData.role = displayRoleMap[userData.role] as "System Admin" | "Department Admin" | "Employee"
    setUser(userData)
