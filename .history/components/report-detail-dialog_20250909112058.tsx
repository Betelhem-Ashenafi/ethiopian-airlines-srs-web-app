...
export default function ReportDetailDialog({ report, isOpen, onClose }: ReportDetailDialogProps) {
  ...
  const [currentDepartment, setCurrentDepartment] = useState(report.department ?? "");
  const [currentSeverity, setCurrentSeverity] = useState(report.severity ?? "Low");
