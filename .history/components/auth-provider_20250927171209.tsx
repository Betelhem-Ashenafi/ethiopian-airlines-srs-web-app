...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    async function restoreUser() {
      setIsLoading(true)
h      // If using mock data, only use localStorage for session
      ...
      // Real backend: fetch user profile and merge with cached
      try {
        ...
        if (profile) {
          ...
          merged.department = cached?.department || profile.department || ""
          const normalized = {
            ...merged,
