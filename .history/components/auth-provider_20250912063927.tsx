  ...
  useEffect(() => {
    ...
    async function restoreUser() {
      ...
      try {
        ...
        if (profile) {
          // normalize role values coming from backend (sysAdmin/deptAdmin/employee)
          try {
            const r = (profile as any).role
            if (r && typeof r === 'string') {
              const rl = r.toLowerCase()
              if (rl.includes('sys')) (profile as any).role = 'System Admin'
              else if (rl.includes('dept')) (profile as any).role = 'Department Admin'
              else if (rl.includes('employee')) (profile as any).role = 'Employee'
            }
          } catch (e) {
