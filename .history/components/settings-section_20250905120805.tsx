                            ...
                            <div key={dept.id} className="bg-white rounded-md p-4 border border-gray-100">
                              <div className="grid gap-2">
                                <div className="flex justify-between items-center">
                                  ...
                                  <Button size="sm" variant="outline" onClick={() => openEditDept(dept)}>Edit</Button>
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  <div>{dept.departmentEmail}</div>
                                </div>
                                <div>
                                  <div className="text-xs text-muted-foreground">Contact</div>
                                  <div>{dept.contactNumber}</div>
                                </div>
                                <div className="flex items-center justify-between">
                                  <label className="flex items-center gap-2">
                                    <input className="h-4 w-4" type="checkbox" checked={!!dept.isActive} readOnly />
                          ...
                          <Dialog open={!!editDeptId} onOpenChange={closeEditDept}>
                            <DialogContent className="max-w-md">
                              ...
                              <div className="grid gap-3">
                                <div>
                                  <Label>Name</Label>
                                  <Input value={editDeptFields.name} onChange={e => setEditDeptFields(f => ({ ...f, name: e.target.value }))} />
                                </div>
                                <div>
                                  <Label>Description</Label>
                                  <Input value={editDeptFields.description} onChange={e => setEditDeptFields(f => ({ ...f, description: e.target.value }))} />
                                </div>
                                <div>
                                  <Label>Email</Label>
                                  <Input value={editDeptFields.departmentEmail} onChange={e => setEditDeptFields(f => ({ ...f, departmentEmail: e.target.value }))} />
                                </div>
                                <div>
                                  <Label>Contact</Label>
                                  <Input value={editDeptFields.contactNumber} onChange={e => setEditDeptFields(f => ({ ...f, contactNumber: e.target.value }))} />
                                </div>
                                ...
                                <div className="flex gap-2 justify-end mt-2">
                                  ...
                                  <Button variant="ghost" onClick={closeEditDept}>Cancel</Button>
                                </div>
                              </div>
                            </DialogContent>
                          </Dialog>
