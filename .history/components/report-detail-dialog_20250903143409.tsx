        ...
        <div className="grid gap-4">
          ...
          <div className="flex gap-4">
            <div className="w-48 h-32 bg-gray-100 rounded overflow-hidden">
              { (fetched?.imageUrl ?? report.imageUrl) ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={fetched?.imageUrl ?? report.imageUrl} alt="report image" className="w-full h-full object-cover" />
              ) : (
            ...
            <div className="flex-1">
              ...
              <div className="mb-4 text-sm">{fetched?.description ?? report.description}</div>

              <div className="grid grid-cols-3 gap-2">
                <div>
                  <Label>Status</Label>
                  <Select value={currentStatus} onValueChange={(v) => setCurrentStatus(v as any)}>
                ...
                <div>
                  ...
                  <Select value={currentDepartment} onValueChange={(v) => setCurrentDepartment(v as any)}>
                ...
                <div>
                  ...
                  <Select value={currentSeverity} onValueChange={(v) => setCurrentSeverity(v as any)}>
                    <SelectTrigger className="w-full"><SelectValue /></SelectTrigger>
                    <SelectContent>
