...
export type Report = {
  ...
  statusName?: string
  // Optional backend ID fields for robust filtering/matching (added to align with fetchReports mapping)
  statusId?: string
  severityId?: string
  departmentId?: string
  syncStatus?: string
...
export type User = {
  ...
  department?: string // Department name for Department Admins
  departmentId?: string // Department ID for Department Admins (used for filtering)
}
